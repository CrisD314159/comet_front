'use client'
import { VerifyAccount } from "@/lib/serverActions/putActions/PutActions"
  ...
  return(
    <div className="w-full h-full flex justify-center items-center">
       <form onSubmit={handleSubmit} method="POST" className="space-y-6 max-sm:w-[90%]">
            <div>
              <p className="text-2xl font-bold">Enter your email and received code to verify your account</p>
            </div>
            <div>
